package com.shunping.shifou.base;
...
public abstract class BaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerViewHolder> {
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, int position) {
        ...
        if (!mShowEmptyView && mOnLoadMoreListener != null
                && (mEnableLoadMore != null && mEnableLoadMore)
                && !mShowLoadMoreView && position == getItemCount() - 1
                && getItemCount() >= mMoreItemCount) {
            mShowLoadMoreView = true;
            holder.itemView.postDelayed(new Runnable() {
                @Override
                public void run() {
    ...
    public void setOnLongItemClicklistener(OnLongItemClickListener longItemClicklistener) {
        mOnLongItemClickListener = longItemClicklistener;
    }
